/*I edited this file to load multiple cps data file.  The key requirement is that*/
/*they use a standard dictionary, but if I were a little clever I could change*/
/*this pretty easily.*/

/*Jeff Borowitz 2011-02-13*/

local files "apr96pub aug96pub dec96pub feb96pub jan96pub jul96pub jun96pub mar96pub may96pub nov96pub oct96pub sep96pub"
set mem 1000m
foreach file of local files{
label drop _all
capture log close
log using `file', text replace
...
local dat_name "`file'.cps"

/* The following line should contain the path to your output '.dta' file */

local dta_name "./`file'.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name "./cpsbsep95.dct"
...
set mem 2000m
use jan96pub.dta
append using feb96pub.dta
append using mar96pub.dta
append using apr96pub.dta
append using may96pub.dta
append using jun96pub.dta
append using jul96pub.dta
append using aug96pub.dta
append using sep96pub.dta
append using oct96pub.dta
append using nov96pub.dta
append using dec96pub.dta
save cps96.dta, replace
sample 10000, count
save cps96-sample.dta
